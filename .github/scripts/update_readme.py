    ...
    if filename.endswith(".md"):
        with open(os.path.join(profiles_dir, filename), 'r') as f:
            ...
            try:
                ...
                im = Image.open(os.path.join("static/images", image))
                im.thumbnail((250, 250))
                
                # Save the resized image to a different path or with a unique name
                im.save(os.path.join("static/images", "resized_" + image), "JPEG")
